...
const projects: IProject[] = [
  {
    ...
    skillList: ["js", "react", "styledcomponents", "ts"],
    repository: {
  ...
  },
  {
    ...
    skillList: ["js", "nextjs", "react", "styledcomponents", "ts"],
    repository: {
  ...
  },
  {
    ...
    skillList: ["cypress", "nextjs", "react", "tailwind", "ts"],
    repository: {
  ...
  },
  {
    ...
    skillList: ["react", "sass", "ts", "vite", "vitest"],
    repository: {
  ...
  },
  {
    ...
    skillList: ["js", "react", "sass", "ts", "vite"],
    repository: {
...
class ProjectStore {
  ...
  public sortByHighlight(): IProject[] {
  ...
  public sortByPresentation(): IProject[] {
