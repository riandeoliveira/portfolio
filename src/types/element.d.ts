...
export type DivElementProps = HTMLAttributes<HTMLDivElement> &
  ComponentWithChildren;
export type HeadingElementProps = HTMLAttributes<HTMLHeadingElement> &
  ComponentWithChildren;
export type InputElementProps = InputHTMLAttributes<HTMLInputElement>;
export type LabelElementProps = LabelHTMLAttributes<HTMLLabelElement> &
  ComponentWithChildren;
export type ParagraphElementProps = HTMLAttributes<HTMLParagraphElement> &
  ComponentWithChildren;
export type SpanElementProps = HTMLAttributes<HTMLSpanElement> &
  ComponentWithChildren;
