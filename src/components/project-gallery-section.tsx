...
export const ProjectGallerySection = (): ReactElement => {
  ...
  return (
    <section
      ref={elementRef}
      className="h-[160rem] overflow-hidden antialiased relative flex flex-col self-auto [perspective:600px] [transform-style:preserve-3d] max-s-600:h-[150rem] text-zinc-50"
    >
